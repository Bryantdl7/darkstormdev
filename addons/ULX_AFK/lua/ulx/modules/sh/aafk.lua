...
CreateConVar("ulx_afk_ignoresuperadmins", 0, FCVAR_ARCHIVE, "Should we ignore AFK admins? (1=yes, 0=no).")
...
if SERVER then
	function ulx.CheckAFK( pl )
		...
		if pl:IsSuperAdmin() and GetConVarNumber( "ulx_afk_ignoresuperadmins" ) == 1 then
			return
		end
